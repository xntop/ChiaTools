...
class Ui_MineWidget(object):
    ...
    def retranslateUi(self, MineWidget):
        ...
        self.label_2.setText(_translate("MineWidget", "矿机名称"))
        self.label.setText(_translate("MineWidget", "API Key"))
        self.label_4.setText(_translate("MineWidget", "Plot文件数："))
        self.labelCurrentCount.setText(_translate("MineWidget", "10个"))
        self.label_3.setText(_translate("MineWidget", "算力："))
