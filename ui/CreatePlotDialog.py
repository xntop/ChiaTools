...
class Ui_CreatePlotDialog(object):
    def setupUi(self, CreatePlotDialog):
        ...
        CreatePlotDialog.resize(513, 401)
        ...
        self.formLayout.setWidget(7, QtWidgets.QFormLayout.FieldRole, self.spinNumber)
        ...
        self.formLayout.setWidget(8, QtWidgets.QFormLayout.FieldRole, self.timeEditDelay)
        ...
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.spinThreadNum)
        ...
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.spinMemory)
        ...
        self.formLayout.setWidget(7, QtWidgets.QFormLayout.LabelRole, self.checkBoxSpecifyCount)
    ...
    def retranslateUi(self, CreatePlotDialog):
        ...
        self.label_2.setText(_translate("CreatePlotDialog", "fpk"))
        self.label_3.setText(_translate("CreatePlotDialog", "ppk"))
